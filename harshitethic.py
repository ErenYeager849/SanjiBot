...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5973216719:AAFlk6uu77iPWu71wgoFRP8VBZbAGo74ebk"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Sanji Vinsmoke'
username = 'Sanji_The_Simp_bot'
